...
namespace DeCompactPlugIn
{
    ...
    /// </summary>
    class MainWindow : ToggleWindow,  IImageInfoSource, INameInfoSource
    {
        public MainWindow()
        {
            //
		...
		{
			get { return new MainWindowImageInfo(); }
		}
		...
		{
			get { return new MainWindowNameInfo(this); }
		}
